...
const Members = () => {
  ...
  return (
    <div className=' flex flex-col items-center justify-center gap-28 md:gap-20 sm:gap-10' >


<h1 className="text-center text-slate-700 m-20 font-mono">
  <span className=" block text-9xl font-bold uppercase max-md:text-8xl max-sm:text-7xl text-teal-600">
   <LetterAnimation
                           text={`SUCCESS`}
                           delay={0.5}
                           duration={0.8}
  ...
  <span className="block text-6xl md:text-5xl max-md:text-4xl max-sm:text-4xl font-light mt-2 text-lime-500">
  <LetterAnimation
                           text='is&nbsp;built'
                           delay={1}
                           duration={0.10}
